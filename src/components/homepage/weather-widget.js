...
export default function WeatherWidget() {
  ...
  const [hour, min, meridiem] = formatTime(new Date());
  return (
    <div className="weather-widget-wrapper">
      ...
      >
        ...
        >
          ...
          <SubTitle>{((hour + 1) % 12) + meridiem}</SubTitle>
        </Grid>
        <Grid
          item
          container
        ...
        >
          ...
          <SubTitle>{((hour + 2) % 12) + meridiem}</SubTitle>
        </Grid>
        <Grid
          item
          container
        ...
        >
          ...
          <SubTitle>{((hour + 3) % 12) + meridiem}</SubTitle>
        </Grid>
        <Grid
          item
          container
        ...
        >
          ...
          <SubTitle>{((hour + 4) % 12) + meridiem}</SubTitle>
        </Grid>
      </Grid>
    </div>
  );
