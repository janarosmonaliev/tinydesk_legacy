        ...
        <Grid container>
            ...
            <img src={Image} style={logoStyle}></img>
                <Grid container style={mainDivStyle}>
                    ...
                    <Typography variant="h3" style={h3Style}>Change the way you organize your bookmarks and use your homepage</Typography>
                    <Typography variant="body2" style={body2Style}>Get started by logging in with your account or sign up with your Google account or email.</Typography>
